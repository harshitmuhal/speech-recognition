...
r=sr.Recognizer() #by this command we have initialised our recogniser
...
with sr.Microphone() as source: #using with keyword session will be closed automaticallly
    ...
    print("Speak!")
    audio=r.listen(source) #our recogniser will now listen to the source and save it to audio
